...
mamdata$PredEndo<-factor(mamdata$PredEndo)
birddata$PredEndo<-factor(birddata$PredEndo)
reptdata$PredEcto<-factor(reptdata$PredEcto)
amphdata$PredEcto<-factor(amphdata$PredEcto)
...
source('C:/Users/anyta/Documents/Scripts/multiplot.R')
...
# intrcpt    0.1467  0.0725   2.0228  0.0431   0.0046   0.2888    *
#   logmass   -0.0798  0.0182  -4.3758  <.0001  -0.1155  -0.0440  ***
...
#estimate      se     zval    pval    ci.lb    ci.ub
#0.0089     0.0227   0.3925  0.6947  -0.0356  0.0534   
...
summary(meta2) #this is the actual hypothesis, QM(df = 3) = 30.6821, p-val < .0001

coef<-data.frame(b =meta2$b, lci = meta2$ci.lb, uci =  meta2$ci.ub)
write.csv(coef, "~/New projects/Island rule/Results/Mammals/Coef/coef_area.csv", row.names = FALSE)
...
write.csv(coef, "~/New projects/Island rule/Results/Mammals/Coef/coef_dist.csv", row.names = FALSE)
...
write.csv(coef, "~/New projects/Island rule/Results/Mammals/Coef/coef_dist_area.csv", row.names = FALSE)
...
# predation pressure ####
# total richness
meta7d<-rma.mv(RR~logmass*TotPredrichEndo,V=Vmam,  data=mamdata,  random= RE,  
               R = phylocor, control=list(optimizer= "bobyqa"),method = "REML")  
summary(meta7d)

coef<-data.frame(b =meta7d$b, lci = meta7d$ci.lb, uci =  meta7d$ci.ub)
write.csv(coef, "~/New projects/Island rule/Results/Mammals/Coef/coef_predrich.csv", row.names = FALSE)

#extract Qm
prednames<-row.names(meta7d$beta)[-1]

test_1pred<-anova(meta7d, btt = 2) 
test_2pred<-anova(meta7d, btt = 3) 
test_int<-anova(meta7d, btt = 4) 
...
write.csv(Qm_tot, "~/New projects/Island rule/Results/Mammals/Coef/anova_predrich.csv")
...
TotPredrichEndo<-quantile(mamdata$TotPredrichEndo, prob = 0.1) 
s<-predict(meta7d, newmods = cbind(logmass,TotPredrichEndo, logmass*TotPredrichEndo), addx=TRUE)

TotPredrichEndo<-quantile(mamdata$TotPredrichEndo, prob = 0.9) #147910.8
l<-predict(meta7d, newmods = cbind(logmass,TotPredrichEndo, logmass*TotPredrichEndo), addx=TRUE)
...
Md1<-ggplot(mamdata)+ #geom_point(aes(logmass,RR), color = "grey",
  #     size = size,shape=16, 
  #     alpha=I(.3)) +scale_shape_identity()+
  geom_hline(yintercept= 0, size=1.2, linetype="dashed", color="dark gray")+theme_bw(base_size=18) +
  geom_line(data=df,aes(logmass,pred,colour=Islandtype, group = Islandtype), size = 1)+ #small remote, red
...
tiff(filename = "~/New projects/Island rule/Results/Mammals/Hyp/predrich.tif")
Md1
dev.off()

###mammalian richness
meta7d2<-rma.mv(RR~logmass*MPredRichEndo,V=Vmam,  data=mamdata,  random= RE,  
               R = phylocor, control=list(optimizer= "bobyqa"),method = "REML")  
summary(meta7d2)

coef<-data.frame(b =meta7d2$b, lci = meta7d2$ci.lb, uci =  meta7d2$ci.ub)
write.csv(coef, "~/New projects/Island rule/Results/Mammals/Coef/coef_predrich_mam.csv", row.names = FALSE)

#extract Qm
prednames<-row.names(meta7d2$beta)[-1]

test_1pred<-anova(meta7d2, btt = 2) 
test_2pred<-anova(meta7d2, btt = 3) 
test_int<-anova(meta7d2, btt = 4) 
...
write.csv(Qm_tot, "~/New projects/Island rule/Results/Mammals/Coef/anova_predrich_mam.csv")

Qm <- paste0("QM(df = 1) = ", round(as.numeric(test_int[1]), digits = 3), ", p-val = ", round(as.numeric(test_int[2]), digits = 3))

# Calculation R2
mR2.func(meta7d2) #11.93

# richness of predators
logmass <- seq(from = min(mamdata$logmass), to = max(mamdata$logmass), length.out = 1000)

MPredRichEndo<-quantile(mamdata$MPredRichEndo, prob = 0.1) 
s<-predict(meta7d2, newmods = cbind(logmass,MPredRichEndo, logmass*MPredRichEndo), addx=TRUE)

MPredRichEndo<-quantile(mamdata$MPredRichEndo, prob = 0.9) #147910.8
l<-predict(meta7d2, newmods = cbind(logmass,MPredRichEndo, logmass*MPredRichEndo), addx=TRUE)
...
Md2<-ggplot(mamdata)+ #geom_point(aes(logmass,RR), color = "grey",
  #     size = size,shape=16, 
  #     alpha=I(.3)) +scale_shape_identity()+
  geom_hline(yintercept= 0, size=1.2, linetype="dashed", color="dark gray")+theme_bw(base_size=18) +
  geom_line(data=df,aes(logmass,pred,colour=Islandtype, group = Islandtype), size = 1)+ #small remote, red
...
tiff(filename = "~/New projects/Island rule/Results/Mammals/Hyp/predrich_mam.tif")
Md2
dev.off()

# presence
meta7e<-rma.mv(RR~logmass*PredEndo,V=Vmam,  data=mamdata,  random= RE,  
               R = phylocor, control=list(optimizer= "bobyqa"),method = "REML")  
summary(meta7e)

coef<-data.frame(b =meta7e$b, lci = meta7e$ci.lb, uci =  meta7e$ci.ub)
write.csv(coef, "~/New projects/Island rule/Results/Mammals/Coef/coef_pred.csv", row.names = FALSE)

#extract Qm
prednames<-row.names(meta7e$beta)[-1]

test_1pred<-anova(meta7e, btt = 2) 
test_2pred<-anova(meta7e, btt = 3) 
test_int<-anova(meta7e, btt = 4) 
...
write.csv(Qm_tot, "~/New projects/Island rule/Results/Mammals/Coef/anova_pred.csv")

Qm <- paste0("QM(df = 1) = ", round(as.numeric(test_int[1]), digits = 3), ", p-val = ", round(as.numeric(test_int[2]), digits = 3))

# Calculation R2
mR2.func(meta7e) #14.91

PredEndo<-0
nv<-predict(meta7e, newmods = cbind(logmass,PredEndo, logmass*PredEndo), addx=TRUE) 
PredEndo<-1
v<-predict(meta7e, newmods = cbind(logmass,PredEndo,logmass*PredEndo), addx=TRUE) 
...
Md3<-ggplot(mamdata)+ #geom_point(aes(logmass,RR), color = "grey",
  #     size = size,shape=16, 
  #     alpha=I(.3)) +scale_shape_identity()+
  geom_hline(yintercept= 0, size=1.2, linetype="dashed", color="dark gray")+theme_bw(base_size=18) +
  geom_line(data=df,aes(logmass,pred,colour=Islandtype, group = Islandtype), size = 1)+ #small remote, red
...
tiff(filename = "~/New projects/Island rule/Results/Mammals/Hyp/pred_pres.tif")
Md3
dev.off() #makes no sense --> 20 zeroes, 704 ones
...
write.csv(coef, "~/New projects/Island rule/Results/Mammals/Coef/coef_ndvi.csv", row.names = FALSE)
...
write.csv(coef, "~/New projects/Island rule/Results/Mammals/Coef/coef_sdndvi.csv", row.names = FALSE)
...
# temperature####
meta6f<-rma.mv(RR~logmass*tmean,V=Vmam,  data=mamdata,random= RE,  
               R = phylocor, control=list(optimizer= "bobyqa"),method = "REML")  
summary(meta6f) 

coef<-data.frame(b =meta6f$b, lci = meta6f$ci.lb, uci =  meta6f$ci.ub)
write.csv(coef, "~/New projects/Island rule/Results/Mammals/Coef/coef_tmean.csv", row.names = FALSE)

#extract Qm
prednames<-row.names(meta6f$beta)[-1]

test_1pred<-anova(meta6f, btt = 2) 
test_2pred<-anova(meta6f, btt = 3) 
test_int<-anova(meta6f, btt = 4) 
...
# Calculation R2
mR2.func(meta6f) #13.86

#temperature
tmean<-quantile(mamdata$tmean, prob = 0.9, names = FALSE) #27 degrees
w<-predict(meta6f, newmods = cbind(logmass, tmean, logmass*tmean), addx=TRUE) 

tmean<-quantile(mamdata$tmean, prob = 0.1, names =FALSE) #6.1 degrees
c<-predict(meta6f, newmods = cbind(logmass, tmean,logmass*tmean), addx=TRUE) 
...
write.csv(coef, "~/New projects/Island rule/Results/Mammals/Coef/coef_tmean_int.csv", row.names = FALSE)
...
#temperature
tmean<-quantile(mamdata$tmean, prob = 0.9, names = FALSE) #27 degrees
w<-predict(meta6, newmods = cbind(logmass, tmean), addx=TRUE) 

tmean<-quantile(mamdata$tmean, prob = 0.1, names =FALSE) #6.1 degrees
c<-predict(meta6, newmods = cbind(logmass, tmean), addx=TRUE) 
...
Mg2<-ggplot(mamdata)+ #geom_point(aes(logmass,RR), color = "grey",
  #     size = size,shape=16, 
  #     alpha=I(.3)) +scale_shape_identity()+
  geom_hline(yintercept= 0, size=1.2, linetype="dashed", color="dark gray")+theme_bw(base_size=18) +
  geom_line(data=df,aes(logmass,pred,colour=Islandtype, group = Islandtype), size = 1)+ #small remote, red
...
write.csv(coef, "~/New projects/Island rule/Results/Mammals/Coef/coef_tseas.csv", row.names = FALSE)
...
meta8<-rma.mv(RR~logmass*guild2,V=Vmam,  data=mamdata,  random= RE,  
              R = phylocor, control=list(optimizer= "bobyqa"),method = "REML")  
summary(meta8)

coef<-data.frame(b =meta8$b, lci = meta8$ci.lb, uci =  meta8$ci.ub)
write.csv(coef, "~/New projects/Island rule/Results/Mammals/Coef/coef_diet.csv", row.names = FALSE)
...
c<-predict(meta8, newmods = cbind(logmass, 0, 0), addx=TRUE)
nc<-predict(meta8, newmods = cbind(logmass, 1, logmass), addx=TRUE)
...
Mi<-ggplot(mamdata)+ #geom_point(aes(logmass,RR), color = "grey",
  #     size = size,shape=16, 
  #     alpha=I(.3)) +scale_shape_identity()+
  geom_hline(yintercept= 0, size=1.2, linetype="dashed", color="dark gray")+theme_bw(base_size=18) +
  geom_line(data=df,aes(logmass,pred,colour=Islandtype, group = Islandtype), size = 1)+
...
tiff('~/New projects/Island rule/Results/Figures/Figure_hyp_mam_upd1.tif', res=300, width=6000, height=6000, compression = "lzw")
multimam
dev.off()
...
write.csv(coef, "~/New projects/Island rule/Results/Birds/Coef/coef_area.csv", row.names = FALSE)
...
write.csv(coef, "~/New projects/Island rule/Results/Birds/Coef/coef_distance.csv", row.names = FALSE)
...
write.csv(coef, "~/New projects/Island rule/Results/Birds/Coef/coef_distance_area.csv", row.names = FALSE)
...
write.csv(coef, "~/New projects/Island rule/Results/Birds/Coef/coef_predrich.csv", row.names = FALSE)
...
write.csv(Qm_tot, "~/New projects/Island rule/Results/Birds/Coef/anova_predrich.csv")
...
tiff(filename = "~/New projects/Island rule/Results/Birds/Hyp/predrich.tif")
Bd1
dev.off()
...
write.csv(coef, "~/New projects/Island rule/Results/Birds/Coef/coef_predrich_mam.csv", row.names = FALSE)
...
write.csv(Qm_tot, "~/New projects/Island rule/Results/Birds/Coef/anova_predrich_mam.csv")
...
tiff(filename = "~/New projects/Island rule/Results/Birds/Hyp/predrich_mam.tif")
Bd2
dev.off()
...
write.csv(coef, "~/New projects/Island rule/Results/Birds/Coef/coef_pred.csv", row.names = FALSE)
...
write.csv(Qm_tot, "~/New projects/Island rule/Results/Birds/Coef/anova_pred.csv")
...
tiff(filename = "~/New projects/Island rule/Results/Birds/Hyp/pred_pres.tif")
Bd3
...
write.csv(coef, "~/New projects/Island rule/Results/Birds/Coef/coef_ndvi.csv", row.names = FALSE)
...
write.csv(coef, "~/New projects/Island rule/Results/Birds/Coef/coef_sdndvi.csv", row.names = FALSE)
...
write.csv(coef, "~/New projects/Island rule/Results/Birds/Coef/coef_tmean.csv", row.names = FALSE)
...
tiff(filename = "~/New projects/Island rule/Results/Birds/Hyp/tmean.tif")
Bg
dev.off()
...
write.csv(coef, "~/New projects/Island rule/Results/Birds/Coef/coef_tmean_int.csv", row.names = FALSE)
...
tiff(filename = "~/New projects/Island rule/Results/Birds/Hyp/tmean_intercept.tif") #interactive effect
Bg2
dev.off()
...
write.csv(coef, "~/New projects/Island rule/Results/Birds/Coef/coef_tseas.csv", row.names = FALSE)
...
write.csv(coef, "~/New projects/Island rule/Results/Birds/Coef/coef_diet.csv", row.names = FALSE)
...
tiff('~/New projects/Island rule/Results/Figures/Figure_hyp_birds_upd1.tif', res=300, width=6000, height=6000, compression = "lzw")
multibirds
dev.off()

multibirds<-ggarrange(Ba,Bb,Bc,Bd2,Be,Bf,Bg,Bh, Bi, ncol = 3, nrow = 3, align = "v")
tiff('~/New projects/Island rule/Results/Figures/Figure_hyp_birds_upd2.tif', res=300, width=6000, height=6000, compression = "lzw")
multibirds
dev.off()
...
write.csv(coef, "~/New projects/Island rule/Results/Reptiles/Coef/coef_distance.csv", row.names = FALSE)
...
write.csv(coef, "~/New projects/Island rule/Results/Reptiles/Coef/coef_distance_area.csv", row.names = FALSE)
...
write.csv(coef, "~/New projects/Island rule/Results/Reptiles/Coef/coef_predrich.csv", row.names = FALSE)
...
write.csv(Qm_tot, "~/New projects/Island rule/Results/Reptiles/Coef/anova_predrich.csv")
...
tiff(filename = "~/New projects/Island rule/Results/Reptiles/Hyp/predrich.tif")
Rd1
dev.off()
...
write.csv(coef, "~/New projects/Island rule/Results/Reptiles/Coef/coef_predrich_mam.csv", row.names = FALSE)
...
write.csv(Qm_tot, "~/New projects/Island rule/Results/Reptiles/Coef/anova_predrich_mam.csv")
...
tiff(filename = "~/New projects/Island rule/Results/Reptiles/Hyp/predrich_mam.tif")
Rd2
dev.off()
...
write.csv(coef, "~/New projects/Island rule/Results/Reptiles/Coef/coef_pred.csv", row.names = FALSE)
...
write.csv(Qm_tot, "~/New projects/Island rule/Results/Reptiles/Coef/anova_pred.csv")
...
tiff(filename = "~/New projects/Island rule/Results/Reptiles/Hyp/pred_pres.tif")
Rd3
dev.off()
...
tiff(filename = "~/New projects/Island rule/Results/Reptiles/Hyp/tmean.tif")
Rg
dev.off()
...
tiff(filename = "~/New projects/Island rule/Results/Reptiles/Hyp/tmean_intercept.tif") #interactive effect
Rg2
dev.off()
...
tiff('~/New projects/Island rule/Results/Figures/Figure_hyp_rept_upd1.tif', res=300, width=6000, height=6000, compression = "lzw")
multirept
dev.off()
...
write.csv(coef, "~/New projects/Island rule/Results/Amphibians/Coef/coef_predrich.csv", row.names = FALSE)
...
write.csv(Qm_tot, "~/New projects/Island rule/Results/Amphibians/Coef/anova_predrich.csv")
...
tiff(filename = "~/New projects/Island rule/Results/Amphibians/Hyp/predrich.tif")
Ad1
dev.off()
...
write.csv(coef, "~/New projects/Island rule/Results/Amphibians/Coef/coef_predrich_mam.csv", row.names = FALSE)
...
write.csv(Qm_tot, "~/New projects/Island rule/Results/Amphibians/Coef/anova_predrich_mam.csv")
...
tiff(filename = "~/New projects/Island rule/Results/Amphibians/Hyp/predrich_mam.tif")
Ad2
dev.off()
...
write.csv(coef, "~/New projects/Island rule/Results/Amphibians/Coef/coef_pred.csv", row.names = FALSE)
...
write.csv(Qm_tot, "~/New projects/Island rule/Results/Amphibians/Coef/anova_pred.csv")
...
tiff(filename = "~/New projects/Island rule/Results/Amphibians/Hyp/pred_pres.tif")
Ad3
dev.off()
...
write.csv(Qm_tot, "~/New projects/Island rule/Results/Amphibians/Coef/anova_prec_int.csv")
...
tiff('~/New projects/Island rule/Results/Figures/Figure_hyp_amph_upd1.tif', res=300, width=6000, height=6000, compression = "lzw")
multiamph
dev.off()
