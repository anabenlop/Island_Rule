...
data_imp_temp<-data_imp[!(data_imp$Reference == "Pigot et al. 2020" & data_imp$Measure != "Wing Length"),]
...
write.csv(birddata_def,file= "Data/birddata_def_tarsus.csv", row.names = FALSE) #727 rows
