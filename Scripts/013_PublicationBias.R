...
saveRDS(metamam_bias, file = "~/New projects/Island rule/Data/Final data/metamam_bias.Rdata")
...
saveRDS(metamam_bias2, file = "~/New projects/Island rule/Data/Final data/metamam_bias2.Rdata")
...
saveRDS(metabird_bias, file = "~/New projects/Island rule/Data/Final data/metabird_bias.Rdata")
...
saveRDS(metabird_bias2, file = "~/New projects/Island rule/Data/Final data/metabird_bias2.Rdata")
...
saveRDS(metarept_bias, file = "~/New projects/Island rule/Data/Final data/metarept_bias.Rdata")
...
saveRDS(metarept_bias2, file = "~/New projects/Island rule/Data/Final data/metarept_bias2.Rdata")
...
saveRDS(metaamph_bias, file = "~/New projects/Island rule/Data/Final data/metaamph_bias.Rdata")
...
saveRDS(metaamph_bias2, file = "~/New projects/Island rule/Data/Final data/metaamph_bias2.Rdata")
