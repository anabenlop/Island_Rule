...
int_text<-annotate(geom="text", x= 9, y= 2, label= int, size = 4)
slo_text<-annotate(geom="text", x= 9, y= 1, label= slo, size = 4)
...
int_text<-annotate(geom="text", x= 7, y= 1.5, label= int, size = 4)
slo_text<-annotate(geom="text", x= 7, y= 1, label= slo, size = 4)
...
int_text<-annotate(geom="text", x= 7, y= -1, label= int, size = 4)
slo_text<-annotate(geom="text", x= 7, y= -2, label= slo, size = 4)
...
int_text<-annotate(geom="text", x= 2, y= -1.2, label= int, size = 4)
slo_text<-annotate(geom="text", x= 2, y= -1.5, label= slo, size = 4)
